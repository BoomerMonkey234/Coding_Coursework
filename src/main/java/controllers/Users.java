...
public class Users{
    ...
    @POST
    @Path("add")
    public String UsersAdd(@FormDataParam("UserID") Integer UserID, @FormDataParam("UserName") String UserName, @FormDataParam("Roll") String Roll, @FormDataParam("Authentication") String Authentication, @FormDataParam("Password") String Password) {
        System.out.println("Invoked Users.UsersAdd()");
        try {
            PreparedStatement ps = Main.db.prepareStatement("INSERT INTO Users (UserID, UserName, Roll, Authentication, Password) VALUES (?, ?, ?, ?, ?)");
            ps.setInt(1, UserID);
            ps.setString(2, UserName);
            ps.setString(3, Roll);
            ps.setString(4, Authentication);
